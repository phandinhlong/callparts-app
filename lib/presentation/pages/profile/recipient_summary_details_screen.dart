...
import 'package:callparts/presentation/pages/checkout/payment_screen.dart';
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      const ShippingRow(
                          text1: 'Recipient Name:', text2: 'James Powell'),
                      const ShippingRow(
                          text1: 'Phone Number:', text2: '86345454533'),
                      const ShippingRow(
                          text1: 'Email Address:', text2: 'James@gmail.com'),
                      const ShippingRow(
                          text1: 'Street Address:', text2: 'UK 32 Street'),
                      ...
                      const ShippingRow(
                          text1: 'Delivery Date:', text2: '10th July 2024'),
                      const ShippingRow(
                          text1: 'Delivery Time Window:', text2: '2 PM - 4 PM'),
                      const ShippingRow(
                          text1: 'Delivery Instructions:',
                          text2: 'Leave at the front door.'),
                      const ShippingRow(
                          text1: 'Gift Card:', text2: 'Happy Birthday'),
                      const ShippingRow(
                          text1: 'Gift Message:',
                          text2: 'Wishing you all the best!'),
                      const ShippingRow(
                          text1: 'Company:', text2: 'Tech Solutions'),
                      const ShippingRow(
                          text1: 'Apt/Suite/Unit:', text2: 'Apt 101'),
                      const SizedBox(height: 14),
                      const Text1(text1: 'Price Details', size: 18),
                      const SizedBox(height: 6),
                      const ShippingRow(
                          text1: 'MRP (4 Items):', text2: '\$2232'),
                      const ShippingRow(text1: 'Discount:', text2: '\$232'),
                      const ShippingRow(
                          text1: 'Taxes & Charges:', text2: '\$44'),
                      const ShippingRow(
                          text1: 'Delivery Charges:', text2: 'Free'),
                      const SizedBox(height: 6),
                      const Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [

...
import 'Views/grocery_notifications.dart';
import 'Views/privacy_and_policy.dart';
import 'Views/terms_of_services.dart';
                ...
                TabContainer(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const GroceryNotifications()));
                ...
                TabContainer(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const PrivacyandPolicy()));
                  },
                ),
                TabContainer(

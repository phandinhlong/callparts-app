...
import '../../../CommonWidgets/dividdderrr.dart';
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          IconButton(
                            icon: const Icon(Icons.phone,color: AppColors.text3Color,),
                            onPressed: () {
                              // Implement call functionality
                            },
                          ),
                          IconButton(
                            icon: const Icon(Icons.message,color: AppColors.text3Color,),
                            onPressed: () {
                      ...
                      Row(
                        children: [
                          Image.asset('images/MapPin.png',width: 15,color: Colors.white,),
                      ...
                      Row(
                        children: [
                          ...
                          const Text2(
                            text2: ' Your order will be arriving at 4 PM today.',
                            color: Colors.white,
                          ),
                        ],
                      ),

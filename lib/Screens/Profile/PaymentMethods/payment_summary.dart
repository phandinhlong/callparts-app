...
import 'package:autopartsstoreapp/Screens/Profile/PaymentMethods/payment_successfully.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                CustomButton(
                  text: 'Pay Now',
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => const PaymentSuccessfully()));
                  },
                ),
              ],
            ),
